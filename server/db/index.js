...
const seed = async()=> {
  ...
  const [foo, bar, bazz,quq] = await Promise.all([
    ...
    createProduct({ name: 'Cookies and Cream Delight', price: 150.00, description:'Dense, rich chocolate cake is layered with Oreo buttercream.  Outside, the cake is drizzled with caramel and covered in more buttercream and Oreos for a decadent addition to any party.', vip_price: 0, category:'Special Occassions', productImage: oreoCake_image }),
    ...
    createProduct({ name: 'Fluffy Rainbow Cake', price: 200.00, description:'This yummy cake has five colorful layers, each flavored to match the corresponding color of the rainbow: cherry, orange, lemon, lime, and grape. It is decorated with a candy rainbow and clouds covered in rainbow Nerds surround the base.', vip_price: 0, category:'Birthdays', productImage: rainbowCake_image }),
