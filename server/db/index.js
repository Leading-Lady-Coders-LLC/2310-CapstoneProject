...
const seed = async()=> {
  ...
  const [foo, bar, bazz,quq] = await Promise.all([
    ...
    createProduct({ name: 'Tower of Flowers Cake', price: 200.00, description:'This beautiful blue two-tiered cake is great for weddings or showers.  It is carefully adorned with hundreds of delicate white flowers.  Inside the cake is a lightly lemon-flavored chiffon cake with a lemon mousse sandwiched between the cake layers.', vip_price: 180.00, category:'Special Occassions', productImage: 'https://dl.dropboxusercontent.com/s/fhfvljlj2wgxwf6ecb9gy/flower-cake.jpg?rlkey=scn8ntu15c3oq0zk8wrtur7ux&dl=0' }),
    ...
    createProduct({ name: 'Lily Cake', price: 200.00, description:"This small three-layer cake makes a great casual wedding cake or is perfect for Mother's Day. It features a vanilla cake with whip cream frosting. The flowers on top are handpiped and edible.", vip_price: 0, category:'Special Occassions', productImage: 'https://dl.dropboxusercontent.com/s/k631em78xq7x74zrvwg7v/small-wedding-cake.jpg?rlkey=0do7lei4pkg2ni1aiocfqdtye&dl=0' }),
    ...
    createProduct({ name: 'Peaches & Cream Wedding Cake', price: 500.00, description:'This two tiered wedding cake is composed of buttermilk cake, peach buttercream, and filled with peach compote.  The outside is covered in a silky French vanilla buttercream.  Delicate handmade flowers wrap around the outside of the cake.', vip_price: 0, category:'Special Occassions', productImage: 'https://dl.dropboxusercontent.com/s/kh5cs961bkfdqq5qd2o5u/wedding-cake.jpg?rlkey=csp11i6yqzrf7vfnt6ewhvg6u&dl=0' }),
